...
//		
	...
	//@Test(priority = 8 )
		...
		//public void RandomlyLocation() throws InterruptedException,  {
	   ...
	   // String[] locationsEN = {"Dubai", "Jeddah", "Riyadh"};
	    //String[] locationsAR = {"دبي", "جدة", "الرياض"};

	   // Random rand = new Random();
	   // String location;
	   // if(currentLang.equals("En")) {
	       // location = locationsEN[rand.nextInt(locationsEN.length)];
	    //} else {
	       // location = locationsAR[rand.nextInt(locationsAR.length)];
	    //}

	    
	  //  WebElement locationField = driver.findElement(By.xpath("//input[@data-testid='AutoCompleteInput']"));
	...
	//driver.get("https://www.almosafer.com/ar/hotels-home");

	//List<WebElement> options = driver.findElements(By.xpath("//select[@data-testid='HotelSearchBox__ReservationSelect_Select']"));

	// Randomly select between "1 room, 2 adults, 0 children" and "1 room, 1 adult, 0 children"
